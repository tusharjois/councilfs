...
\paragraph{Contribution.} We present \textsc{CouncilFS}, a 
...
Aldermen constitute the second tier of nodes in CouncilFS. These nodes are
trusted by the others in the network to provide file distribution and
logistics services for all of CouncilFS. File storage capabilities are provided
