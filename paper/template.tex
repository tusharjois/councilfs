...
users of the underlying currency of CouncilFS. Aldermen are members of the
...
At the core of the CouncilFS network are members. The underlying token of
CouncilFS, known as a \emph{shire}, is exchanged between users as transactions.
...
Unlike Bitcoin miners, however, CouncilFS members perform a
...
verifier. This PoR is performed by every member on a common dataset $D$; because
...
differences, however. In CouncilFS, the aldermen replace the dealer as the
arbiter of the common dataset. The aldermen decide which members get which
slices of $D$, rather than having a trusted setup phase. Additionally, because
the aldermen handle $D$, it can be updated continuously. Both of these points
...
\subsubsection{Electing New Aldermen}

\subsubsection{Punishing Misbehaving Aldermen}
